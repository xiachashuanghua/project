...
from .roi_heads import StandardROIHeads,select_foreground_proposals
from .keypoint_head import build_keypoint_head
from .roi_heads import select_proposals_with_visible_keypoints
...
class PatchDCTROIHeads(ROIHeads):
    """
