...
from detectron2.data import MetadataCatalog
classnames=['RSV','SARS-CoV-2','FLUAV','HSV1','HAdV5','VACV']
mydata_train_images='/root/virus/train2017' #可以直接写绝对路径
mydata_train_labels='/root/virus/annotations/instances_train2017.json' #可以直接写绝对路径
mydata_val_images='/root/virus/val2017' #可以直接写绝对路径
mydata_val_labels='/root/virus/annotations/instances_val2017.json' #可以直接写绝对路径
